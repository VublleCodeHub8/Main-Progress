...
export const buttons = [
  ...
  },
  {
    ...
    component: (
      <button
        className="px-4 py-2 rounded-md border border-neutral-300 bg-white text-neutral-600 text-sm hover:-translate-y-1 transform transition duration-200 hover:shadow-md">
        Simple
      </button>
    ),
  },
